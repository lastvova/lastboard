...
<div>
    <form role="form" method="post">
        <div class="form-group">
            <label for="advertisementTag">Tag</label>
            <input type="text" class="form-control" id="advertisementTag" placeholder="enter Tag"
                   name="advertisementTag">
            <p class="help-block">Maximum 50 characters</p>
        </div>
        <div class="form-group">
            <label for="advertisementSubject">Subject</label>
            <input type="text" class="form-control" id="advertisementSubject" placeholder="enter subject"
                   name="advertisementSubject">
            <p class="help-block">Maximum 50 characters</p>
        </div>
        <div class="form-group">
            <label for="advertisementBody">Body</label>
            <input type="text" class="form-control" id="advertisementBody" placeholder="enter body"
                   name="advertisementBody">
            <p class="help-block">Maximum 200 characters</p>
        </div>
        <div class="form-group">
            <label for="advertisementDate">Date</label>
            <input type="datetime-local" class="form-control" id="advertisementDate" name="advertisementDate">
        </div>
